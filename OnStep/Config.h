...
// Slewing Speed: 4.9 degrees/second (estimated)
// Generated on: 2021-10-31 06:57
// ---------------------------------------------------------------------------------------------------------------------------------
...
#define SERIAL_C_BLUETOOTH_NAME  "Kepler1" // "On..", Bluetooth device name for ESP32.                                         Option
...
#define WEATHER                       BMP280 //    OFF, BME280 (I2C 0x77,) BME280_0x76, BME280_SPI (see pinmap for CS.)          Option
...
#define SLEW_RATE_BASE_DESIRED        1.2 //    1.0,1.3 n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define SLEW_RAPID_STOP_DIST          3 //    2.0, n, (degrees.) Approx. distance required to stop when a slew              Adjust
...
#define AXIS1_STEPS_PER_DEGREE    38293 //  12800,38293,76587 n. Number of steps per degree:                                          <-Req'd
...
#define AXIS1_DRIVER_MODEL            TMC2209_VQUIET //    OFF, (See above.) Stepper driver model.      TMC2209_QUIET,DRV8825, TMC2209_VQUIET                   <-Often
...
#define AXIS2_DRIVER_MODEL            TMC2209_VQUIET //    OFF, (See above.) Stepper driver model.             DRV8825                         <-Often      -------> 
...
#define AXIS2_LIMIT_MIN               -35 //    -90, n. Where n=-90..0 (degrees.) Minimum allowed declination.                Infreq
#define AXIS2_LIMIT_MAX                85 //     90, n. Where n=0..90 (degrees.) Maximum allowed declination.                 Infreq
...
#define AXIS4_STEPS_PER_MICRON        12 //    0.5, n. Steps per micrometer. Figure this out by testing or other means. 12     Adjust
#define AXIS4_SLEW_RATE_DESIRED       5000 //    500, n, Where n=200..5000 (um/s.) Max microns/second. In DC mode, max pwr % 5000  Adjust
#define AXIS4_STEP_RATE_MAX           0.1 //      8, n, 0.1 to 100 (milliseconds).This sets the fastest step rate  1 Adjust
...
#define AXIS4_DRIVER_IHOLD            OFF //    OFF, n, 100 to 1000 (mA) Current standstill. OFF uses IRUN/2.0. "       Option
